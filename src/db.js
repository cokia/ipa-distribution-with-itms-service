...
var App = mongoose_1.default.model('app', appSchema);
var app = new App();
function addApp(name, bundleid, version, data) {
...
function callFromAppName(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, App.findOne({ name: name }).select({ __v: 0 })];
        });
    });
}
exports.callFromAppName = callFromAppName;
function appList() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, ((App.find().select({ __v: 0 })))];
        });
    });
}
